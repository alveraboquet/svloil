    ...
    function twenty_twenty_one_posted_by()
    {
        if (!get_the_author_meta('description') && post_type_supports(get_post_type(), 'author')) {
            ...
            /* translators: %s: Author name. */
                ...
                '<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" rel="author">' . esc_html(
                    get_the_author()
                ) . '</a>'
            );
            echo '</span>';
    ...
    function twenty_twenty_one_entry_meta_footer()
    {
        ...
        if (!is_single()) {
            ...
            if ('aside' === $post_format || 'status' === $post_format) {
                echo '<p><a href="' . esc_url(get_permalink()) . '">' . twenty_twenty_one_continue_reading_text(
                    ) . '</a></p>'; // phpcs:ignore WordPress.Security.EscapeOutput
            }
    ...
    function twenty_twenty_one_post_thumbnail()
    {
            ...
            <figure class="post-thumbnail">
                ...
                if (wp_get_attachment_caption(get_post_thumbnail_id())) : ?>
                    <figcaption class="wp-caption-text"><?php
                        echo wp_kses_post(wp_get_attachment_caption(get_post_thumbnail_id())); ?></figcaption>
                <?php
                endif; ?>
        ...
        <?php
            ...
            <figure class="post-thumbnail">
                ...
                the_permalink(); ?>" aria-hidden="true" tabindex="-1">
                    <?php
        ...
        the_posts_pagination(
            array(
                ...
                'prev_text' => sprintf(
                    ...
                    is_rtl() ? twenty_twenty_one_get_icon_svg('ui', 'arrow_right') : twenty_twenty_one_get_icon_svg(
                        'ui',
                        'arrow_left'
                    ),
                    wp_kses(
                ...
                'next_text' => sprintf(
                    ...
                    is_rtl() ? twenty_twenty_one_get_icon_svg('ui', 'arrow_left') : twenty_twenty_one_get_icon_svg(
                        'ui',
                        'arrow_right'
                    )
                ),
